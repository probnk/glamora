...
class _MyCartState extends State<MyCart> {
  ...
  _shoppingCartBottomSheet({required bool isDarkMode}) {
    return Container(
              ...
              Row(
                ...
                children: [
                  Column(
                    ...
                    children: [
                      mediumFont(
                          text: "Total", color: isDarkMode ? white : grayBlack),
                      smallFont(
                          text: "Order now",
  ...
  build(BuildContext context) {
    ...
    return Scaffold(
        ...
        bottomSheet:
            _shoppingCartBottomSheet(isDarkMode: themeProvider.isDarkMode),
